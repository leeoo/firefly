...
jvm_params="-Dbind_host=10.147.22.162 -Dbind_port=9900 -Dloop=2000 -Dthread_num=500 -Dasyn=0 -Xms1024m -Xmx1024m -Xss1m -XX:NewSize=256m -XX:MaxNewSize=256m -XX:+UseCompressedOops -XX:+UseConcMarkSweepGC -XX:+DisableExplicitGC -XX:PermSize=64m -XX:MaxPermSize=64m"
