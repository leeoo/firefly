...
jvm_params="-Dbind_host=10.147.22.162 -Dbind_port=9900 -Xms4096m -Xmx4096m -XX:+UseCompressedOops -XX:+UseConcMarkSweepGC -XX:+DisableExplicitGC -XX:PermSize=64m -XX:MaxPermSize=64m"
