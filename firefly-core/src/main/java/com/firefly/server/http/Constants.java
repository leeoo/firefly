...
public class Constants {
	...
	static {
		...
		MIME.put("class", "application/x-java.vm");
		...
		MIME.put("pls", "audio/mpegurl");
		MIME.put("pls", "audio/scpls");
		MIME.put("pls", "audio/x-mpequrl");
		MIME.put("pls", "audio/x-scpls");
		MIME.put("pls", "uadio/scpls");
		...
		MIME.put("xml", "text/vnd.IPTC.NITF");
		MIME.put("xml", "text/vnd.IPTC.NewsML");
		MIME.put("xml", "text/vnd.wap.si");
		MIME.put("xml", "text/vnd.wap.sl");
		MIME.put("xml", "text/vnd.wap.wml");
